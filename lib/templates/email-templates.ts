...
export const devolucionConfirmadaHtmlTemplate = (
  ...
  const itemsHtml = items
    .map(
      (item) => `
    <tr>
      <td style="padding:10px 0; border-bottom:1px solid rgba(169,146,125,0.15); font-size:14px; color:#49111c; font-family:Georgia, 'Times New Roman', serif;">
        ${escapeHtml(item.titulo)}
      </td>
      <td style="padding:10px 0; border-bottom:1px solid rgba(169,146,125,0.15); font-size:13px; color:#5e503f; text-align:right; font-family:Georgia, 'Times New Roman', serif;">
...
<head>
  ...
  <title>Devolución Registrada — Biblioteca de Alejandría</title>
</head>
        ...
        <table role="presentation" width="520" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr>
            <td style="padding:0 40px 24px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                     style="background-color:#f2f4f3; border:1px solid #a9927d; border-radius:12px; padding:20px;">
                <tr>
                  <td>
                    <p style="margin:0 0 12px; font-size:12px; color:#a9927d; text-transform:uppercase; letter-spacing:1px; font-weight:bold;">
          ...
          <tr>
            <td align="center" style="padding:0 40px 28px;">
              <p style="margin:0 0 16px; font-size:14px; color:#5e503f; font-family:Georgia, 'Times New Roman', serif;">
              ...
              ${qrDataUrl ? `<img src="${qrDataUrl}" alt="Código QR de devolución" width="160" height="160"
                   style="display:block; margin:0 auto 20px; border-radius:8px; border:1px solid #a9927d;" />` : ""}
              <a href="${detalleUrl}"
